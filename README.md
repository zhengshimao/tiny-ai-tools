...
| ------------------------------------------- | ------------------------------------------------------------ | ------------------------------------------------------------ | ------------ |
| [fastq_qc](./fastq_qc/)                     | 基于 fastp v1.3.3 的轻量 FASTQ 质控工具，单文件 C++，支持单双端、gzip 自动识别、多格式输出 | per-cycle 质量/含量/长度分布/GC 统计 · Q20/Q30/Q40 检测 · 重复率 · 插入片段峰值 · 文本/JSON/TSV 输出。 | [1](#coding-agent) |
